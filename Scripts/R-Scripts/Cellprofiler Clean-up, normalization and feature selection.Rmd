...
aggr_plot <- aggr(features, col=c('navyblue','red'), numbers=TRUE, sortVars=TRUE, 
                  labels=names(data), cex.axis=.7, gap=3, ylab=c("Histogram of missing data","Pattern")) #Summarizing pattern plot
```
...
#Lasly Export datasets for further downstream analysis--------------------------
```{r}
