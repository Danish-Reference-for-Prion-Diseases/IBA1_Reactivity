...
```{r}
#Scatter matrix
interest <- components$Disease #Variable of Interest - CortexLayer, Disease, BrainRegion, Sex, Patient or Slide
...
```{r}
interaction_plot("HLA DR")
#Options: "P2ry12", "Ki 67", "TMEM119", "CD11c", "CD39", "IBA1", "CD45", "CD68", "CD40", "HLA DR", "CD11b", "CSF1R", "CD31", "CTSD", "CD9", "MERTK", "GPNMB")
```
