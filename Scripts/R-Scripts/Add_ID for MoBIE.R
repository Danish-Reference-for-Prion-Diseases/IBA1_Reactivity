...
ggsave("legendformobie.png", path = here("Figures and Tables", "Figure 3"), width = 3.5, height = 1, device='png', dpi=300)

#Segments - Object Cluster ID
par(family = "sans")
png("legendformobie2.png", width = 4800, height = 3200, res = 1200)
...
setwd(here("Figures and Tables", "Figure 3"))
dev.off() 
