...
#Merge Soma and Total (Primary and Secondary objects)---------------------------
...
#Object Outliers detection and filtering----------------------------------------
...
#Filtered Features
filtered_heat <- eval_heatmap(Filtered_data, paste("Filtered Single IBA1+ Objects (n =", nrow(Filtered_data),")"), paste("Filtered Morphometric Features (n =", ncol(normalized_features),")"))
filtered_heat
